...
public class CommentController {
    ...
    @PostMapping
    ResponseEntity<Void> createComment(@AuthenticationPrincipal Long userId, @PathVariable Long postId,
    ...
    @DeleteMapping
    ResponseEntity<Void> deleteComment(@AuthenticationPrincipal Long userId, @PathVariable Long postId) {
